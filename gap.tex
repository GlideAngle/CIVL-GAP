...
\begin{enumerate}
    \item
        ...
        1 point}, see Fig~\ref{fig:planar-two-point}.\\The point \(R\) is the
          intersection of $\overleftrightarrow{AB}$ and the circle.
    \item
        Line segment $\overleftrightarrow{AB}$ \textbf{crosses the circle in
        2 points.}, see Fig~\ref{fig:planar-two-point}.\\ The point \(R\) is
    ...
    \item
        ...
        circle}, see Fig~\ref{fig:planar-two-point}.\\ The new point \(R\) is
...
\begin{figure}[h]
    \centering
    \input{shortest-path-planar/one-cross}
    \caption{Line segment crosses the circle in one point}
    \label{fig:planar-two-point}
\end{figure}
