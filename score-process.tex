...
\node (comp) [io, below of=start, xshift=7cm] {1: Define competition parameters};
\node (task) [io, below of=comp, xshift=-7cm] {2: Define task};
...
\node (ranktask) [decision, below of=score] {8: Rank task};
\node (rankcomp) [decision, below of=ranktask] {9: Rank competition};
