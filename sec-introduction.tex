...
\begin{itemize}
    \item
        "The GAP Guide",
        \href
        {http://fs.fai.org/trac/raw-attachment/wiki/ScoringFormulas/thegapguide.pdf}
        {2011 edition}.
    \item
        FAI Sporting Code Section 7A for Hang-Gliding,
        \href
        {https://www.fai.org/sites/default/files/civl/documents/sporting_code_s7a-cross_country_2017_1_0.pdf}
        {2017 edition}.
    \item
        FAI Sporting Code Section 7B for Paragliding,
        \href
        {https://www.fai.org/sites/default/files/civl/documents/sporting_code_s7b-aerobatic_2017_1_0.pdf}
        {2017 edition}.
    \item
        The \href{https://github.com/FAI-CIVL/FS}{scoring implementation}
        \footnote{A private repository of FAI-CIVL but due to be open sourced.}
        within CIVL’s scoring software, FS\footnote{FS is also known as FScomp.}.
    \item
        Appendix C of the Paragliding World Cup Association's Competition Rules,
        \href {http://pwca.org/rules/PWCA%20Competition%20Rules%202017.pdf}
        {2017 edition}.
\end{itemize}
