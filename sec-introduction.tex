...
\begin{itemize}
    \item
        ...
        {2011 edition}.
    \item
        Sporting Code Section 7A - Cross Country,
        \href
        {https://www.fai.org/sites/default/files/civl/documents/sporting_code_s7a-cross_country_2018_v2.pdf}
        {2018 v2 edition}.
    \item
    ...
    \item
        Appendix C of the Paragliding World Cup Association Competition Rules,
        \href {http://pwca.org/rules/PWCA%20Competition%20Rules%202018.pdf}
        {2018 edition}.
\end{itemize}
